...
from app.vjepa_suspension.transforms import make_transforms
from app.vjepa_suspension.utils import init_opt, init_video_model, load_checkpoint, init_temporal_adapter
...
def main(args, resume_preempt=False):
    ...
    temporal_adapter = init_temporal_adapter(device, cfgs_model)
